...
export default function Home() {
  ...
  const { selectedChat, sendMessage } = UseAppContext();
    ...
    <div className='bg-[#0f0f0f]'>
      <div className='flex h-screen overflow-hidden'>
        ...
        <div className='flex-1 flex flex-col bg-gradient-to-b from-[#0f0f0f] to-[#1a1a1a] text-white relative'>
          ...
          <div className='flex-1 overflow-y-auto px-4 pt-6 md:pt-8 pb-4 scrollbar-thin scrollbar-thumb-gray-700 scrollbar-track-transparent'>
            {messages.length === 0 ? (
              <motion.div 
              ...
              >
                ...
                >
                  {[
                    { text: 'Explain a complex concept', color: 'from-blue-500/10 to-blue-600/10 border-blue-500/20' },
                    { text: 'Help me write code', color: 'from-purple-500/10 to-purple-600/10 border-purple-500/20' },
                    { text: 'Create content for me', color: 'from-pink-500/10 to-pink-600/10 border-pink-500/20' },
                    { text: 'Solve a problem', color: 'from-green-500/10 to-green-600/10 border-green-500/20' },
                  ].map((item, index) => (
                    <motion.div
                      key={index}
                      whileTap={{ scale: 0.98 }}
                      ...
                      className={`bg-gradient-to-br ${item.color} border rounded-3xl p-4 cursor-pointer backdrop-blur-md transition-all shadow-sm`}
                    >
